...
bot.on('message', (msg) => {
  ...
  if (userMsg === "/start"){
    ...
    bot.sendMessage(chatId, `⫸⫷⫷⫷[👑 BOT OWNER INFO ]⫸⫸⫸⫷\n║\n ◈ Owner: 𝗝𝗼𝘀𝗲𝗽𝗵 𝗞𝘄𝗮𝗯𝗲𝗻𝗮 𝗢𝘀𝗲𝗶 𝗕𝗼𝗻𝘀𝘂(OligoCodes)\n ◈ Role: Developer & Architect 🤖\n ◈ Location: Kasoa, Ghana 🇬🇭\n ◈ Contact: https://t.me/OligoCodes\n\n.  📡 𝗣𝗼𝘄𝗲𝗿𝗲𝗱 𝗯𝘆 𝗢𝗹𝗶𝗴𝗼𝗧𝗲𝗰𝗵 🇬🇭 `, buttons);
     ...
     const musicUrl = 'https://github.com/OligoCodes/OligoGram-Telegram-Bot/main/Alive.mp3';
     const details = { caption : `I'm always alive ${username} 👻👻👻\n\n📡 𝗣𝗼𝘄𝗲𝗿𝗲𝗱 𝗯𝘆 𝗢𝗹𝗶𝗴𝗼𝗧𝗲𝗰𝗵 🇬🇭` ,title: `𝗔𝗹𝗶𝘃𝗲 👽` ,performer: 'OligoGram 💠', thumb : fs.createReadStream('https://github.com/OligoCodes/OligoGram-Telegram-Bot/OligoGram_bot.jpg')};
     bot.sendAudio(chatId, fs.createReadStream(musicUrl), details);
